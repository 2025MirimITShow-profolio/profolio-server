import { Controller, Post, Get, Patch, Delete, Body, Param, UploadedFiles, UseInterceptors, NotFoundException, HttpException, HttpStatus } from '@nestjs/common';
...
export class ProgressLogController {
  ...
  async createProgress(
    ...
    try {
      const progress_log = await this.progressLogService.createProgress(files, projectId, title, links, content);
      return {
        message: '저장 성공',
        progress_log
      }
